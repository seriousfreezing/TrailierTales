	...
	public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> registry) {
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						...
						.add(LootItem.lootTableItem(Items.DYE.red()).setWeight(3))
		...
		registry.accept(
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						.add(LootItem.lootTableItem(Items.DYE.blue()).setWeight(20))
						.add(LootItem.lootTableItem(Items.DYE.yellow()).setWeight(20))
						.add(LootItem.lootTableItem(Items.WHEAT).setWeight(20))
						.add(LootItem.lootTableItem(Items.DYED_CANDLE.blue()).setWeight(20))
		...
		registry.accept(
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						.add(LootItem.lootTableItem(Items.DYE.brown()).setWeight(20))
						.add(LootItem.lootTableItem(Items.DYE.white()).setWeight(20))
						.add(LootItem.lootTableItem(Items.DYE.green()).setWeight(10))
						.add(LootItem.lootTableItem(Items.DYED_CANDLE.brown()).setWeight(20))
						.add(LootItem.lootTableItem(Items.DYED_CANDLE.white()).setWeight(20))
						.add(LootItem.lootTableItem(Items.DYED_CANDLE.green()).setWeight(20))
						.add(LootItem.lootTableItem(Items.EMERALD).setWeight(20))
						.add(LootItem.lootTableItem(Items.WHEAT).setWeight(20))
						.add(LootItem.lootTableItem(Items.WHEAT_SEEDS).setWeight(10))
						...
						.add(LootItem.lootTableItem(Items.LIGHTNING_ROD.weathering().unaffected()).setWeight(5))
		...
		registry.accept(
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						.add(LootItem.lootTableItem(Items.DYE.red()).setWeight(20))
						.add(LootItem.lootTableItem(Items.DYE.yellow()).setWeight(20))
						.add(LootItem.lootTableItem(Items.DYE.purple()).setWeight(20))
						.add(LootItem.lootTableItem(Items.DYED_CANDLE.red()).setWeight(20))
						.add(LootItem.lootTableItem(Items.DYED_CANDLE.yellow()).setWeight(20))
						.add(LootItem.lootTableItem(Items.EMERALD).setWeight(20))
						.add(LootItem.lootTableItem(Items.WHEAT).setWeight(20))
						.add(LootItem.lootTableItem(Items.WHEAT_SEEDS).setWeight(10))
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						...
						.add(LootItem.lootTableItem(Items.STRING).setWeight(10))
						.add(LootItem.lootTableItem(Items.LEATHER).setWeight(10))
						.add(LootItem.lootTableItem(Items.WOOL.white()).setWeight(8))
						.add(LootItem.lootTableItem(Items.WOOL.red()).setWeight(8))
						.add(LootItem.lootTableItem(Items.CARPET.white()).setWeight(20))
						.add(LootItem.lootTableItem(Items.CARPET.red()).setWeight(20))
						.add(LootItem.lootTableItem(Items.LEAD).setWeight(10))
		...
		registry.accept(
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						.add(LootItem.lootTableItem(Items.DYE.orange()).setWeight(15))
						.add(LootItem.lootTableItem(Items.DYE.red()).setWeight(15))
						.add(LootItem.lootTableItem(Items.DYE.yellow()).setWeight(15))
						.add(LootItem.lootTableItem(Items.DYE.brown()).setWeight(15))
						.add(LootItem.lootTableItem(Items.DYED_CANDLE.orange()).setWeight(15))
						.add(LootItem.lootTableItem(Items.DYED_CANDLE.red()).setWeight(15))
						.add(LootItem.lootTableItem(Items.DYED_CANDLE.yellow()).setWeight(15))
						.add(LootItem.lootTableItem(Items.DYED_CANDLE.brown()).setWeight(15))
						.add(LootItem.lootTableItem(Items.EMERALD).setWeight(20))
